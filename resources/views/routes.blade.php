  ...
  <nav class="navbar navbar-dark sticky-top bg flex-md-nowrap shadow">
    ...
    <ul class="navbar-nav px-3">
      <li class="nav-item text-nowrap">
        <a class="logout" href="{{ url('/test') }}">LOGOUT</a>
      </li>
    </ul>
  </nav>
      ...
      <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
        ...
        <div
          ...
          <h1 class="head_dash">Route details</h1>
           ...
           <p><button class="add_details">Add routes details +</button></p>
        </div>

        <form class="route-bus hidden" method="post" action="{{ url('/routes') }}">
            @csrf
          <div class="form-group">
              <label for="city">From:</label>
              <input type="text" id="fcity" name="fromCity" required>
          </div>

          <div class="form-group">
            <label for="city">To:</label>
            <input type="text" id="tcity" name="toCity" required>
        </div>
